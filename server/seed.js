...
const p = (seed, w = 1600, h = 900) => `https://picsum.photos/seed/${seed}/${w}/${h}`;
...
const TRIPS = [
  ...
  },
  {
    ...
    summary: 'No city prepares you for Varanasi. We arrived at the ghats before dawn, watching the Ganga reflect a thousand flames from the morning aarti. The old city is a labyrinth of temples and chai stalls and silk weavers working by lamplight. It is overwhelming in every sense — and completely impossible to forget.',
    accent: '#C87D5A',
  ...
  },
  {
    ...
    summary: 'The road clings to the cliffs like an afterthought. We hired a small motorboat one afternoon and saw the whole coast from the sea — Positano stacked like a wedding cake, Ravello perched impossibly high, lemons the size of grapefruits at every roadside stall. We ate too much pasta. We regret nothing.',
    accent: '#7DAF6E',
  ...
  },
  {
    ...
    summary: 'Mist over the lochs, deer on the hillside, castles half-swallowed by heather. We drove the North Coast 500 in a campervan over nine days, sleeping in lay-bys with views that would have made Turner weep. Glen Coe at sunrise was one of those photographs that could have made a career.',
    accent: '#9898B4',
...
async function seed() {
  ...
  const user = new User({ name: 'Admin', email: 'admin@gmail.com', password: hash, username: 'admin' });
  await user.save();
  ...
  await Profile.create({
    ...
    quote: 'The camera is an excuse to be someplace you otherwise don\'t belong.',
    gear: ['Fujifilm X-T5', 'XF 16-80mm f/4', 'XF 50mm f/2', 'DJI Mini 4 Pro', 'Peak Design Everyday Backpack'],
    interests: [
      { title: 'Long Exposure', body: 'There is something meditative about setting up a shot that takes two minutes to expose. Waterfalls become silk, crowds disappear, and the photograph becomes something that never existed in real life.' },
      { title: 'Street Photography', body: 'A borrowed moment from a stranger\'s day. I love the ethics and the chaos of it — the discipline of seeing in a fraction of a second and committing to the frame.' },
      { title: 'Golden Hour Light', body: 'The twenty minutes either side of sunrise and sunset when everything turns to fire. Planning a shoot around them is half the creative process; the other half is just showing up.' },
      { title: 'Architecture', body: 'Old buildings tell stories through their erosion. A tiled courtyard, a peeling doorway, a stairwell catching a single shaft of light — these are the things I photograph when I\'m not sure what else to shoot.' },
      { title: 'Wildlife', body: 'Patience and stillness. The reward is not guaranteed and that\'s exactly the point. I am still learning to see animals the way the great wildlife photographers do — as subjects rather than prizes.' },
    ],
  });
